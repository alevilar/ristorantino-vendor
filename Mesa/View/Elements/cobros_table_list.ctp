...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('Editar'), array('plugin' => 'mesa', 'controller' => 'Pagos', 'action'=>'edit', $pago['Pago']['id']), array('class'=>'btn btn-warning btn-edit')); ?>
			<?php echo $this->Html->link(__('Eliminar'), array('action'=>'delete', $pago['Pago']['id']), array('class'=>'btn btn-danger'), __('Are you sure you want to delete # %s?', $pago['Pago']['id'])); ?>
		</td>
	</tr>
<?php
 endforeach;
