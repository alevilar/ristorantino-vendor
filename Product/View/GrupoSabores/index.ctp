<div class="grupoSabores index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('seleccion_de_sabor_obligatorio', array('label'=>__('Selección obligatoria')));?></th>
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $grupoSabor['GrupoSabor']['id']), null, __('Seguro queres eliminar el Adicional id# %s?', $grupoSabor['GrupoSabor']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
